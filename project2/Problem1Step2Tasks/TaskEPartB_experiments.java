...
// ***** TASK E, part b *****
// Returns the final clustered data points along with their cluster centers.

public class TaskEPartB_experiments {
    ...
    public static class KMeansMapper extends Mapper<Object, Text, Text, Text> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text(centroidKey), new Text(x + "," + y));
        }
    }
    ...
    public static class KMeansReducer extends Reducer<Text, Text, Text, Text> {
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            for (String point : points) {
                context.write(new Text(point), new Text(Xavg + "," + Yavg));
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: java TaskEPartB <K> <R>");
            System.exit(1);
        }
        ...
        while (iteration < maxIterations && !converged) {
            conf.set("centroids.path", "centroids_partE-b/iteration-" + iteration + "/part-r-00000");

            System.out.println("Running iteration " + iteration + " for K=" + K);

            Job job = Job.getInstance(conf, "TaskEPartB K=" + K + " Iteration=" + iteration);
            job.setJarByClass(TaskEPartB_experiments.class);
            ...
            Path outputPath = new Path("centroids_partE-b/iteration-" + (iteration + 1));
            ...
            converged = checkConvergence("centroids_partE-b/iteration-" + iteration + "/part-r-00000",
                    "centroids_partE-b/iteration-" + (iteration + 1) + "/part-r-00000",
                    conf);
            iteration++;
        }

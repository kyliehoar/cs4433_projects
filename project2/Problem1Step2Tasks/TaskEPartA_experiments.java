...
// ***** TASK E, part a *****
// Returns only cluster centers and indicates if convergence has been reached.

public class TaskEPartA_experiments {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: java TaskEPartA <K> <R>");
            System.exit(1);
        }
        ...
        while (iteration < maxIterations && !converged) {
            conf.set("centroids.path", "centroids_partE-a/iteration-" + iteration + "/part-r-00000");

            System.out.println("Running iteration " + iteration + " for K=" + K);

            Job job = Job.getInstance(conf, "TaskEPartA K=" + K + " Iteration=" + iteration);
            job.setJarByClass(TaskEPartA_experiments.class);
            ...
            Path outputPath = new Path("centroids_partE-a/iteration-" + (iteration + 1));
            ...
            converged = checkConvergence("centroids_partE-a/iteration-" + iteration + "/part-r-00000",
                    "centroids_partE-a/iteration-" + (iteration + 1) + "/part-r-00000",
                    conf);
            iteration++;
        }

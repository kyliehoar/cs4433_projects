...
public class TaskEPartB {
    ...
    public static class KMeansReducer extends Reducer<Text, Text, Text, Map<Double, Double>> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text(Xavg + "," + Yavg), centroidMap);
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (iteration < maxIterations && !converged) {
            conf.set("centroids.path", "/Users/kyliehoar/IdeaProjects/cs4433_project2/centroids_partE-b/iteration-" + iteration + "/part-r-00000");
            Job job = Job.getInstance(conf, "Task e" + iteration);
            job.setJarByClass(TaskEPartB.class);
            job.setMapperClass(TaskEPartB.KMeansMapper.class);
            job.setCombinerClass(KMeansCombiner.class);
            job.setReducerClass(TaskEPartB.KMeansReducer.class);
...
//            FileInputFormat.addInputPath(job, new Path(args[1]));
            FileOutputFormat.setOutputPath(job, new Path("/Users/kyliehoar/IdeaProjects/cs4433_project2/centroids_partE-b/iteration-" + (iteration + 1)));
...
//            converged = checkConvergence("/user/cs4433/project2/centroids_partD/iteration-" + iteration + "/part-r-00000", "/user/cs4433/project2/centroids_partD/iteration-" + (iteration + 1) + "/part-r-00000", threshold, maxShift, conf);
            converged = checkConvergence("/Users/kyliehoar/IdeaProjects/cs4433_project2/centroids_partE-b/iteration-" + iteration + "/part-r-00000", "/Users/kyliehoar/IdeaProjects/cs4433_project2/centroids_partE-b/iteration-" + (iteration + 1) + "/part-r-00000", conf);
            iteration++;
        }
    }

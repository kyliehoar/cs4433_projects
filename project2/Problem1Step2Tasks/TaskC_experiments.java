...
public class TaskC_experiments {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: java TaskC <K> <R>");
            System.exit(1);
        }
        ...
        while (iteration < maxIterations && !converged) {
            conf.set("centroids.path", "centroids/iteration-" + iteration + "/part-r-00000");

            System.out.println("Running iteration " + iteration + " for K=" + K);

            Job job = Job.getInstance(conf, "TaskC K=" + K + " Iteration=" + iteration);
            job.setJarByClass(TaskC_experiments.class);
            ...
            Path outputPath = new Path("centroids/iteration-" + (iteration + 1));
            ...
            converged = checkConvergence("centroids/iteration-" + iteration + "/part-r-00000",
                    "centroids/iteration-" + (iteration + 1) + "/part-r-00000",
                    conf);
            iteration++;
        }
